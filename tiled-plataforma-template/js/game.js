...
GameState.prototype.update = function() {
    ...
    this.game.physics.arcade.collide(this.player, this.lavaLayer, this.lavaDeathCollision, null, this);
...
GameState.prototype.lavaDeathCollision = function(player, lava){
